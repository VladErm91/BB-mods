this.yuu_god <- this.inherit("scripts/entity/tactical/actor", {
	m = {},
	...
	function create()
	{
		this.m.Type = this.Const.EntityType.YuuGod;
		...
		this.m.AIAgent = this.new("scripts/ai/tactical/agents/yuu_god_agent");
	...
	function assignRandomEquipment()
	{
		...
		{
			this.m.Items.equip(this.new("scripts/items/weapons/legendary/flame_greatsword"));
		}
