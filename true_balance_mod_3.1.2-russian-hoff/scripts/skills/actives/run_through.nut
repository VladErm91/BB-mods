this.run_through <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.run_through";
		this.m.Name = "Пробежка";
		this.m.Description = "Пронзительная атака, направленная на прорыв вражеской линии. Может нанести удар по двум противникам, стоящим на прямой линии.";
		this.m.KilledString = "Пронзён";
		this.m.Icon = "skills/split_estoc.png";
		this.m.IconDisabled = "skills/split_estoc_sw.png";
		this.m.Overlay = "split_estoc";
		this.m.SoundOnUse = [
	...
	function getTooltip()
	{
		...
		ret.push({
			...
			text = "Может поразить до 2-х целей"
		});
