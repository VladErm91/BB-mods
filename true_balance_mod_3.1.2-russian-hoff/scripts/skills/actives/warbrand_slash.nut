this.warbrand_slash <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.warbrand_slash";
		this.m.Name = "Разрез";
		this.m.Description = "Стремительный рубящий удар, наносящий средний урон.";
		this.m.KilledString = "Выпотрошен";
