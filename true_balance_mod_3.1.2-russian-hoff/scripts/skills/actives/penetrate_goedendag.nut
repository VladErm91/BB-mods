this.penetrate_goedendag <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.penetrate_goedendag";
		this.m.Name = "Проникновение";
		this.m.Description = "Мощный выпад, наносящий огромный урон по броне противника.";
