this.hive_queen_bite_skill <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.hive_queen_bite";
		this.m.Name = "Укус сетеплёта";
		this.m.Description = "";
		this.m.KilledString = "Разорван в клочья";
