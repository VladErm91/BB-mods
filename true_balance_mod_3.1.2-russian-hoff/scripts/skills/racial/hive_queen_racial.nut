this.hive_queen_racial <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "racial.hive_queen";
		this.m.Name = "Яд";
	...
	function onUpdate( _properties )
	{
		...
		_properties.MeleeSkill += (num - 1);
		_properties.MeleeDefense += (num - 1);
		_properties.RangedDefense += (num - 1);
	}
