::mods_registerMod("mod_engineer", 1.8, "True Balance Mod Engineer");
::mods_queue("mod_engineer", "mod_true_balance", function() {
...
::mods_hookExactClass("entity/tactical/humans/engineer", function ( a )
{
