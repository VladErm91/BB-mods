::mods_registerMod("mod_gunner", 1.8, "True Balance Mod Gunner");
::mods_queue("mod_gunner", "mod_true_balance", function() {
...
::mods_hookExactClass("entity/tactical/humans/gunner", function ( a )
{
