::mods_registerMod("mod_assassin", 1.8, "True Balance Mod Assassin");
::mods_queue("mod_assassin", "mod_true_balance", function() {
...
::mods_hookExactClass("entity/tactical/humans/assassin", function ( a )
{
...
::mods_hookBaseClass("entity/tactical/human", function ( a )
{
	...
	a.create = function ()
	{
		...
		if (this.ClassName == "assassin")
		{
			this.m.AIAgent = this.new("scripts/ai/tactical/agents/mod_assassin_agent");
