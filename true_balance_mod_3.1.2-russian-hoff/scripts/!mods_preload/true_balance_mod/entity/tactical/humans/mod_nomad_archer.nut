::mods_registerMod("mod_nomad_archer", 1.8, "True Balance Mod Nomad Archer");
::mods_queue("mod_nomad_archer", "mod_true_balance", function() {
::mods_hookBaseClass("entity/tactical/human", function ( a )
{
	...
	a.assignRandomEquipment <- function()
	{
		...
		if (this.ClassName == "nomad_archer")
		{
...
::mods_hookExactClass("entity/tactical/humans/nomad_archer", function ( a )
{
