::mods_registerMod("mod_nomad_slinger", 1.8, "True Balance Mod Nomad Slinger");
::mods_queue("mod_nomad_slinger", "mod_true_balance", function() {
::mods_hookBaseClass("entity/tactical/human", function ( a )
{
	...
	a.assignRandomEquipment <- function()
	{
		...
		if (this.ClassName == "nomad_slinger")
		{
...
::mods_hookExactClass("entity/tactical/humans/nomad_slinger", function ( a )
{
