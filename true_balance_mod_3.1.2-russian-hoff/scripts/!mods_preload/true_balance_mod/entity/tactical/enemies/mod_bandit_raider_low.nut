::mods_registerMod("mod_bandit_raider_low", 1.8, "True Balance Mod Bandit Raider Low");
::mods_queue("mod_bandit_raider_low", "mod_true_balance", function() {
::mods_hookBaseClass("entity/tactical/enemies/bandit_raider", function ( a )
{
	...
	a.assignRandomEquipment <- function()
	{
		...
		if (this.ClassName == "bandit_raider_low")
		{
