::mods_registerMod("mod_zombie_yeoman", 1.8, "True Balance Mod Zombie Yeoman");
::mods_queue("mod_zombie_yeoman", "mod_true_balance", function() {
::mods_hookBaseClass("entity/tactical/enemies/zombie", function ( a )
{
	...
	a.assignRandomEquipment <- function()
	{
		...
		if (this.ClassName == "zombie_yeoman")
		{
