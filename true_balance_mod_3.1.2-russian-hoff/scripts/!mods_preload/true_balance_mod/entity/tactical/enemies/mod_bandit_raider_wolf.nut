::mods_registerMod("mod_bandit_raider_wolf", 1.8, "True Balance Mod Bandit raider Wolf");
::mods_queue("mod_bandit_raider_wolf", "mod_true_balance", function() {
::mods_hookDescendants("entity/tactical/enemies/bandit_raider", function ( a )
{
	...
	a.assignRandomEquipment <- function()
	{
		...
		if (this.ClassName == "bandit_raider_wolf")
		{
