this.manhunter_agent <- this.inherit("scripts/ai/tactical/agent", {
	m = {},
	function create()
	{
		this.agent.create();
		this.m.ID = "agent.manhunter";
	...
	function onAddBehaviors()
	{
		...
		this.addBehavior(this.new("scripts/ai/tactical/behaviors/ai_whip_slave"));
