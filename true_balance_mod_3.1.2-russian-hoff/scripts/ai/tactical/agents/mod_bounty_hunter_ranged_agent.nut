this.mod_bounty_hunter_ranged_agent <- this.inherit("scripts/ai/tactical/agent", {
	m = {},
	function create()
	{
		this.agent.create();
		...
		this.m.Properties.BehaviorMult[this.Const.AI.Behavior.ID.KeepSafe] = 1.6;
		...
		this.m.Properties.OverallDefensivenessMult = 1.6;
