this.mod_skeleton_heavy_polearm_agent <- this.inherit("scripts/ai/tactical/agent", {
	m = {},
	function create()
	{
		this.agent.create();
	...
	function onAddBehaviors()
	{
		...
		this.addBehavior(this.new("scripts/ai/tactical/behaviors/ai_long_impale_skeleton"));
