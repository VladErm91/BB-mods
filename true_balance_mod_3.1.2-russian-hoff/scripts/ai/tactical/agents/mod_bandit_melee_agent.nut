this.mod_bandit_melee_agent <- this.inherit("scripts/ai/tactical/agent", {
	m = {},
	function create()
	{
		this.agent.create();
	...
	function onAddBehaviors()
	{
		...
		this.addBehavior(this.new("scripts/ai/tactical/behaviors/ai_long_impale"));
		this.addBehavior(this.new("scripts/ai/tactical/behaviors/ai_wake_up_ally"));
		this.addBehavior(this.new("scripts/ai/tactical/behaviors/ai_attack_default"));
		this.addBehavior(this.new("scripts/ai/tactical/behaviors/ai_longsword_slash"));
		this.addBehavior(this.new("scripts/ai/tactical/behaviors/ai_distant_pound"));
		this.addBehavior(this.new("scripts/ai/tactical/behaviors/ai_lunge"));
	...
	function onUpdate()
	{
		...
		if (item != null && item.isItemType(this.Const.Items.ItemType.Weapon) && item.getRangeIdeal() == 2 && item.getID() != "weapon.estoc" && item.getID() != "weapon.named_estoc" && item.getID() != "weapon.fencing_sword" && item.getID() != "weapon.named_fencing_sword" && item.getID() != "weapon.goedendag")
		{
