this.ai_distant_pound <- this.inherit("scripts/ai/tactical/behavior", {
	m = {
		TargetTile = null,
		PossibleSkills = [
			"actives.pounds"
	...
	function create()
	{
		this.m.ID = this.Const.AI.Behavior.ID.DistantPound;
		this.m.Order = this.Const.AI.Behavior.Order.DistantPound;
	...
	function onEvaluate( _entity )
	{
		...
		return this.Math.max(0, this.Const.AI.Behavior.Score.DistantPound * bestTarget.Score * score);
	}
