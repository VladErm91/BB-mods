this.ai_long_impale_skeleton <- this.inherit("scripts/ai/tactical/behavior", {
	m = {
		TargetTile = null,
		PossibleSkills = [
	...
	function create()
	{
		this.m.ID = this.Const.AI.Behavior.ID.LongImpale;
		this.m.Order = this.Const.AI.Behavior.Order.LongImpale;
	...
	function onEvaluate( _entity )
	{
		...
		return this.Math.max(0, this.Const.AI.Behavior.Score.LongImpale * bestTarget.Score);
	}
