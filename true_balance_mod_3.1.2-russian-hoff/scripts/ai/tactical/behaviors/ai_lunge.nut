this.ai_lunge <- this.inherit("scripts/ai/tactical/behavior", {
	m = {
		TargetTile = null,
		PossibleSkills = [
			"actives.lunge",
			"actives.lunge_goedendag"
		],
		Skill = null
	},
	function create()
	{
		this.m.ID = this.Const.AI.Behavior.ID.Lunge;
		this.m.Order = this.Const.AI.Behavior.Order.Lunge;
	...
	function onEvaluate( _entity )
	{
		...
		return this.Math.max(0, this.Const.AI.Behavior.Score.Lunge * bestTarget.Score * score);
	}
